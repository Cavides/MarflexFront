        ...
        <div className="contain">
          ...
          <div className="col">
            ...
            <ul>
              ...
              <li><a href={pdf} target="_blank" rel="noreferrer"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-filetype-pdf" viewBox="0 0 16 16">
          ...
          <div className="col">
            ...
            <ul>
              ...
              <li><a href="https://www.facebook.com/EmpresaMarflex" target="_blank" rel="noreferrer">Facebook</a></li>
